...
801035ec:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  ...
  release(&ptable.lock);
801035f2:	e8 99 0e 00 00       	call   80104490 <release>
...
80103614:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103617:	c7 40 14 4f 57 10 80 	movl   $0x8010574f,0x14(%eax)
...
80103623:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103626:	e8 b5 0e 00 00       	call   801044e0 <memset>
...
80103648:	e8 43 0e 00 00       	call   80104490 <release>
  return 0;
...
8010366b:	e8 20 0e 00 00       	call   80104490 <release>
...
801036c0:	e8 bb 0b 00 00       	call   80104280 <initlock>
}
...
8010373a:	68 50 76 10 80       	push   $0x80107650
...
80103774:	83 ec 04             	sub    $0x4,%esp
  ...
  struct proc *p;
  pushcli();
80103777:	e8 84 0b 00 00       	call   80104300 <pushcli>
  c = mycpu();
...
801037e6:	e8 f5 0c 00 00       	call   801044e0 <memset>
...
80103845:	e8 96 0e 00 00       	call   801046e0 <safestrcpy>
  p->cwd = namei("/");
...
80103860:	e8 7b 0b 00 00       	call   801043e0 <acquire>
...
80103873:	e8 18 0c 00 00       	call   80104490 <release>
}
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103898:	e8 63 0a 00 00       	call   80104300 <pushcli>
  c = mycpu();
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103919:	e8 e2 09 00 00       	call   80104300 <pushcli>
  c = mycpu();
...
801039c1:	e8 1a 0d 00 00       	call   801046e0 <safestrcpy>
...
801039d0:	e8 0b 0a 00 00       	call   801043e0 <acquire>
...
801039e3:	e8 a8 0a 00 00       	call   80104490 <release>
...
80103a5e:	e8 7d 09 00 00       	call   801043e0 <acquire>
...
80103a99:	c7 43 8c 04 00 00 00 	movl   $0x4,-0x74(%ebx)
      ...
      swtch(&(c->scheduler), p->context);
80103aa0:	e8 96 0c 00 00       	call   8010473b <swtch>
      switchkvm();
...
80103ac8:	e8 c3 09 00 00       	call   80104490 <release>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103ae5:	e8 16 08 00 00       	call   80104300 <pushcli>
  c = mycpu();
...
80103b02:	e8 a9 08 00 00       	call   801043b0 <holding>
...
80103b43:	e8 f3 0b 00 00       	call   8010473b <swtch>
  mycpu()->intena = intena;
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103ba9:	e8 52 07 00 00       	call   80104300 <pushcli>
  c = mycpu();
...
80103c12:	e8 c9 07 00 00       	call   801043e0 <acquire>
...
80103cdc:	e8 ff 06 00 00       	call   801043e0 <acquire>
// while reading proc from the cpu structure
struct proc*
myproc(void) {
  struct cpu *c;
  struct proc *p;
  pushcli();
80103ce1:	e8 1a 06 00 00       	call   80104300 <pushcli>
  c = mycpu();
...
80103d09:	e8 82 07 00 00       	call   80104490 <release>
}
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103d2f:	e8 cc 05 00 00       	call   80104300 <pushcli>
  c = mycpu();
...
80103d60:	e8 7b 06 00 00       	call   801043e0 <acquire>
    release(lk);
80103d65:	89 34 24             	mov    %esi,(%esp)
80103d68:	e8 23 07 00 00       	call   80104490 <release>
  }
  // Go to sleep.
  p->chan = chan;
...
80103d8a:	e8 01 07 00 00       	call   80104490 <release>
    acquire(lk);
...
80103d9b:	5d                   	pop    %ebp
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
80103d9c:	e9 3f 06 00 00       	jmp    801043e0 <acquire>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103de5:	e8 16 05 00 00       	call   80104300 <pushcli>
  c = mycpu();
...
80103e02:	e8 d9 05 00 00       	call   801043e0 <acquire>
...
80103ea3:	e8 e8 05 00 00       	call   80104490 <release>
        return pid;
...
80103ebc:	e8 cf 05 00 00       	call   80104490 <release>
      return -1;
...
80103edf:	e8 fc 04 00 00       	call   801043e0 <acquire>
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103f21:	e9 6a 05 00 00       	jmp    80104490 <release>
...
80103f74:	e8 17 05 00 00       	call   80104490 <release>
      return 0;
...
80103fa0:	e8 eb 04 00 00       	call   80104490 <release>
  return -1;
...
80104045:	e8 56 02 00 00       	call   801042a0 <getcallerpcs>
...
80104083:	56                   	push   %esi
    ...
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
      ...
      state = "???";
80104084:	be 00 76 10 80       	mov    $0x80107600,%esi
    }
    cprintf("\n");
  }
}
...
80104095:	74 2e                	je     801040c5 <cps+0x45>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104097:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
8010409a:	ba 00 76 10 80       	mov    $0x80107600,%edx
  char *state;
...
801040a1:	8b 14 85 78 76 10 80 	mov    -0x7fef8988(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
...
801040b3:	52                   	push   %edx
801040b4:	53                   	push   %ebx
801040b5:	ff 73 a4             	pushl  -0x5c(%ebx)
801040b8:	68 0d 76 10 80       	push   $0x8010760d
801040bd:	e8 9e c5 ff ff       	call   80100660 <cprintf>
801040c2:	83 c4 20             	add    $0x20,%esp
801040c5:	83 eb 80             	sub    $0xffffff80,%ebx
  [ZOMBIE]    "zombie"
  };
  struct proc *p;
  char *state;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040c8:	81 fb c0 4d 11 80    	cmp    $0x80114dc0,%ebx
801040ce:	75 c0                	jne    80104090 <cps+0x10>
    else
      state = "???";
    cprintf("(%d, %s, %s, %d)\n", p->pid, p->name, state, p->priority);
  }
...
struct proc *p;
if(pid < 0 || (priority > 20 || priority < 0)) return -1;
801040eb:	85 db                	test   %ebx,%ebx
801040ed:	78 58                	js     80104147 <chpr+0x67>
801040ef:	83 fe 14             	cmp    $0x14,%esi
801040f2:	77 53                	ja     80104147 <chpr+0x67>
acquire(&ptable.lock);
801040f4:	83 ec 0c             	sub    $0xc,%esp
801040f7:	68 20 2d 11 80       	push   $0x80112d20
801040fc:	e8 df 02 00 00       	call   801043e0 <acquire>
80104101:	83 c4 10             	add    $0x10,%esp
for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104104:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80104109:	eb 10                	jmp    8010411b <chpr+0x3b>
8010410b:	90                   	nop
8010410c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104110:	83 ea 80             	sub    $0xffffff80,%edx
80104113:	81 fa 54 4d 11 80    	cmp    $0x80114d54,%edx
80104119:	74 13                	je     8010412e <chpr+0x4e>
{
	if(p->pid==pid) p->priority=priority;
8010411b:	3b 5a 10             	cmp    0x10(%edx),%ebx
8010411e:	75 f0                	jne    80104110 <chpr+0x30>
80104120:	89 72 7c             	mov    %esi,0x7c(%edx)
chpr(int pid, int priority)
{
struct proc *p;
if(pid < 0 || (priority > 20 || priority < 0)) return -1;
acquire(&ptable.lock);
for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104123:	83 ea 80             	sub    $0xffffff80,%edx
80104126:	81 fa 54 4d 11 80    	cmp    $0x80114d54,%edx
8010412c:	75 ed                	jne    8010411b <chpr+0x3b>
{
	if(p->pid==pid) p->priority=priority;
}
...
80104131:	68 20 2d 11 80       	push   $0x80112d20
80104136:	e8 55 03 00 00       	call   80104490 <release>
return pid; }
...
8010414c:	eb f2                	jmp    80104140 <chpr+0x60>
...
8010415a:	68 a8 76 10 80       	push   $0x801076a8
...
801041b5:	e8 66 fb ff ff       	call   80103d20 <sleep>
...
801041c3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801041c9:	e8 a2 f5 ff ff       	call   80103770 <myproc>
...
80104214:	e8 b7 fc ff ff       	call   80103ed0 <wakeup>
  release(&lk->lk);
...
80104253:	e8 18 f5 ff ff       	call   80103770 <myproc>
...
80104309:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010430a:	e8 c1 f3 ff ff       	call   801036d0 <mycpu>
...
8010431f:	e8 ac f3 ff ff       	call   801036d0 <mycpu>
...
80104395:	68 ca 76 10 80       	push   $0x801076ca
...
801043a2:	68 b3 76 10 80       	push   $0x801076b3
...
801043c8:	e8 03 f3 ff ff       	call   801036d0 <mycpu>
...
80104424:	e8 a7 f2 ff ff       	call   801036d0 <mycpu>
getcallerpcs(void *v, uint pcs[])
{
  uint *ebp;
  int i;
...
80104483:	68 d1 76 10 80       	push   $0x801076d1
...
801044cc:	68 d9 76 10 80       	push   $0x801076d9
...
80104797:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010479a:	e8 d1 ef ff ff       	call   80103770 <myproc>
...
801047f5:	e8 76 ef ff ff       	call   80103770 <myproc>
...
{
  struct proc *curproc = myproc();
80104806:	e8 65 ef ff ff       	call   80103770 <myproc>
...
80104848:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010484b:	e8 20 ef ff ff       	call   80103770 <myproc>
...
801048e4:	53                   	push   %ebx
  int num;
  struct proc *curproc = myproc();
801048e5:	e8 86 ee ff ff       	call   80103770 <myproc>
...
801048fa:	8b 14 85 00 77 10 80 	mov    -0x7fef8900(,%eax,4),%edx
...
80104920:	68 e1 76 10 80       	push   $0x801076e1
...
{
  return cps();
801056e4:	e9 97 e9 ff ff       	jmp    80104080 <cps>
...
80105726:	e8 b5 e9 ff ff       	call   801040e0 <chpr>
...
801057b9:	68 c1 77 10 80       	push   $0x801077c1
...
80105850:	ff 24 85 68 78 10 80 	jmp    *-0x7fef8798(,%eax,4)
...
801058b5:	68 24 78 10 80       	push   $0x80107824
...
80105a58:	68 f0 77 10 80       	push   $0x801077f0
80105a5d:	e8 fe ab ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80105a62:	83 c4 14             	add    $0x14,%esp
80105a65:	68 c6 77 10 80       	push   $0x801077c6
...
80105b5f:	bb e8 78 10 80       	mov    $0x801078e8,%ebx
...
8010676d:	68 f0 78 10 80       	push   $0x801078f0
...
80106a24:	68 f6 78 10 80       	push   $0x801078f6
...
80106a31:	68 21 79 10 80       	push   $0x80107921
...
80106a3e:	68 0c 79 10 80       	push   $0x8010790c
...
80106ab9:	68 35 79 10 80       	push   $0x80107935
...
80106b6d:	68 4f 79 10 80       	push   $0x8010794f
...
80106b7a:	68 f0 79 10 80       	push   $0x801079f0
...
80106c11:	68 6d 79 10 80       	push   $0x8010796d
...
80106c43:	68 85 79 10 80       	push   $0x80107985
...
80106d2c:	68 a1 79 10 80       	push   $0x801079a1
...
80106dff:	68 b2 79 10 80       	push   $0x801079b2
...
80106ef5:	68 d6 79 10 80       	push   $0x801079d6
...
80106f02:	68 bc 79 10 80       	push   $0x801079bc
