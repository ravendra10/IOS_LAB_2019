...
main(int argc, char *argv[])
{
  ...
  b1:	83 c3 01             	add    $0x1,%ebx
    printf(1, "W%d\n", k);
  b4:	6a 01                	push   $0x1
  b6:	e8 45 04 00 00       	call   500 <printf>
    wait();
 ...
 120:	d9 05 8c 08 00 00    	flds   0x88c
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49f:	f7 f6                	div    %esi
 4a1:	0f b6 92 98 08 00 00 	movzbl 0x898(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 618:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 61b:	b8 90 08 00 00       	mov    $0x890,%eax
...
free(void *ap)
{
 ...
 6a1:	a1 38 0b 00 00       	mov    0xb38,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 6f7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6f9:	a3 38 0b 00 00       	mov    %eax,0xb38
}
 6fe:	5b                   	pop    %ebx
 6ff:	5e                   	pop    %esi
 700:	5f                   	pop    %edi
 ...
 71a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 71d:	a3 38 0b 00 00       	mov    %eax,0xb38
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 38 0b 00 00    	mov    0xb38,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 7dc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 7df:	89 15 38 0b 00 00    	mov    %edx,0xb38
      return (void*)(p + 1);
 ...
 7f4:	eb e9                	jmp    7df <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7f6:	c7 05 38 0b 00 00 3c 	movl   $0xb3c,0xb38
 7fd:	0b 00 00 
 800:	c7 05 3c 0b 00 00 3c 	movl   $0xb3c,0xb3c
 807:	0b 00 00 
    base.s.size = 0;
 80a:	b8 3c 0b 00 00       	mov    $0xb3c,%eax
 80f:	c7 05 40 0b 00 00 00 	movl   $0x0,0xb40
 816:	00 00 00 
